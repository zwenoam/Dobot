classdef RobotRaconteur
    ...
    methods(Static=true)
		...
		function StartCloudTransportAsClient()
			RobotRaconteurMex('StartCloudTransportAsClient');
		end
		
		function StartCloudTransportAsServer()
			RobotRaconteurMex('StartCloudTransportAsServer');
		end
		
		function ret=IsCloudClientRunning()
			ret=RobotRaconteurMex('IsCloudClientRunning');
		end		
